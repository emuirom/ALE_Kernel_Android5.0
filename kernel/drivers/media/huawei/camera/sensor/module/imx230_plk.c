...
#define MODULE_ID_LITEON 0x03
#define MODULE_ID_LG 0x07
#define MODULE_NAME_SUNNY "imx230_sunny"
#define MODULE_NAME_LITEON "imx230_liteon"
#define MODULE_NAME_LG "imx230_lg"
#define MODULE_NAME_DEFAULT "imx230"
