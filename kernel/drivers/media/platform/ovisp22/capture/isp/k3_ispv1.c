...
const struct isp_reg_t isp_mipi_init_regs1[] = {
	...
	{0x65003, 0xff},
	{0x65004, 0x20}, /*c00144034:ISP2.2 0x65004[1:0]isp_workmode:0:normal or EDR;2:HDR;3:3D;when capture yuv online,should be 0;0x6502f[7]:0:edr(default);1:normal.*/
	{0x65005, 0x52},
	{0x65006, 0x02},
	{0x65008, 0x00},
	{0x65009, 0x00},
...
/* added by z00299055, 2014.12.16, begin */
/*
 **************************************************************************
...
/* added by z00299055, 2014.12.16, end */
 ...
 */
 static void ispv1_wait_for_mac_done(void)
 {
    ...
    /* add by c00144034 debug only.we should ensure MAC finishing writing. */
    if (this_ispdata){
...
static int ispv1_set_zoom(zoom_t *zoom, zoom_quality_t quality)
{
	...
	else
	{
	    ...
	    /* add by c00144034 for mirro end */
	}
...
void ispv1_refresh_yuv_crop_pos(void)
{
    ...
    x = (x) & (~3);
    y = (y) & (~3);
    /* END:   Modified by c00144034, 2013/10/22 */
    /* END:   Modified by w65960, 2013/9/12 */
...
/*
 **************************************************************************
 * FunctionName: ispv1_get_banding_step;
