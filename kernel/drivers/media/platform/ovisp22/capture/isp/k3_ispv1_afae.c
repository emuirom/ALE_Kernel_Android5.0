 ...
 * Input       : camera_rect_s *yuv, calculate constrast area
 * Output      : NA;
 * ReturnValue : NA;
...
/*
 **************************************************************************
 * FunctionName: ispv1_set_focus_mode;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
 * Other       : NA;
...
/*
 **************************************************************************
 * FunctionName: ispv1_set_focus_range;
 ...
 * Description : call by ispv1_auto_focus and ispv1_need_luminance_stable;
...
u32 ispv1_get_focus_rect(camera_rect_s *rect)
{
	...
	ispv1_focus_adjust_yuvrect(rect, preview_width, preview_height, afae_ctrl->zoom); /* added by j00212990 2012-11-14 */
	return 0;
}
...
static u32 ispv1_focus_calc_edge(u8 *pdata, camera_rect_s *rect, int contrast_shift, bool coarse_flag)
{
	...
	int width1 = width << 1;// 2[w00219879@9/02/2013]
	int width2 = width1 + width;   // 3[w00219879@9/02/2013]
	int width3 = width << 2;       // 4[w00219879@9/02/2013]
	int width4 = width3 + width;   // 5[w00219879@9/02/2013]
	int width5 = width3 + width1;  // 6[w00219879@9/02/2013]
	int width6 = width3 + width2;  // 7[w00219879@9/02/2013]
	int width7 = width3 << 1;      // 8[w00219879@9/02/2013]
	int width_shift;
	int step_width;
