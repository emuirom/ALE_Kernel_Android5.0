...
static mini_camera_sensor *primary_sensor_array[CAMERA_SENSOR_NUM_MAX];
static mini_camera_sensor *secondary_sensor_array[CAMERA_SENSOR_NUM_MAX];
static mini_camera_sensor *primary_sensor;
static mini_camera_sensor *secondary_sensor;
...
static mini_camera_flashlight *camera_flash_dev = NULL;
mini_framesize_s mini_camera_framesizes[CAMERA_RESOLUTION_MAX] = {
...
EXPORT_SYMBOL(mini_vcm_ad5823);

/* sensor override parameter definitions. */
u32 mini_sensor_override_params[OVERRIDE_TYPE_MAX] = {
	CAMERA_MAX_ISO,
	CAMERA_MIN_ISO,
...
EXPORT_SYMBOL(mini_sensor_override_params);

/*
 **************************************************************************
 * FunctionName: mini_camera_get_size_by_resolution;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
				  ...
				  u32 *height)
{
	...
	*width = mini_camera_framesizes[res].width;
	*height = mini_camera_framesizes[res].height;

	return 0;
}

EXPORT_SYMBOL(mini_camera_get_size_by_resolution);
...
EXPORT_SYMBOL(mini_camera_get_resolution_type);
...
int mini_camera_get_resolution_by_size(u32 width, u32 height)
{
	...
	for (i = 0; i < ARRAY_SIZE(mini_camera_framesizes); i++) {
		if (width == mini_camera_framesizes[i].width  && height == mini_camera_framesizes[i].height) {
			return i;
		}
	}
...
EXPORT_SYMBOL(mini_camera_get_resolution_by_size);
...
EXPORT_SYMBOL(mini_get_camera_sensor_from_array);
...
EXPORT_SYMBOL(mini_get_camera_sensor_array);
/*
 **************************************************************************
 * FunctionName: mini_get_camera_sensor;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_get_camera_sensor);
...
EXPORT_SYMBOL(mini_set_camera_sensor);

/*
 **************************************************************************
 * FunctionName: mini_clean_camera_sensor;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_clean_camera_sensor);

/*
 **************************************************************************
 * FunctionName: mini_register_camera_sensor;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_register_camera_sensor);

/*
 **************************************************************************
 * FunctionName: mini_unregister_camera_sensor;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_unregister_camera_sensor);

/*
 **************************************************************************
 * FunctionName: mini_dump_camera_sensors;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_dump_camera_sensors);
...
EXPORT_SYMBOL(mini_get_camera_count);

/*
 **************************************************************************
 * FunctionName: mini_get_camera_flash;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
 ...
 **************************************************************************
 */
mini_camera_flashlight *mini_get_camera_flash()
{
	return camera_flash_dev;
}

EXPORT_SYMBOL(mini_get_camera_flash);

/*
 **************************************************************************
 * FunctionName: mini_register_camera_flash;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_register_camera_flash);

/*
 **************************************************************************
 * FunctionName: mini_unregister_camera_flash;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_unregister_camera_flash);

/*
 **************************************************************************
 * FunctionName: mini_camera_power_core_ldo;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_camera_power_core_ldo);
...
/*
 **************************************************************************
 * FunctionName: mini_camera_timing_is_match;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
/*
 **************************************************************************
 * FunctionName: mini_camera_power_id_gpio;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
EXPORT_SYMBOL(mini_camera_power_id_gpio);

/*
 **************************************************************************
 * FunctionName: mini_camera_get_i2c_speed;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
int mini_camera_get_i2c_speed(unsigned int chip_id, i2c_speed_t i2c_speed_idx)
{
	...
	if (chip_id == DI_CHIP_ID) {	/* design-in chip, Mclk=131M */
		return i2c_speed_array[0][i2c_speed_idx];
	} else if (chip_id == CS_CHIP_ID) {	/* mass-produced chip, Mclk=160M */
		return i2c_speed_array[1][i2c_speed_idx];
	} else {
		print_error("----bad chip id, please check---");
		return i2c_speed_array[1][i2c_speed_idx];	/* set default speed */
	}
}
EXPORT_SYMBOL(mini_camera_get_i2c_speed);
