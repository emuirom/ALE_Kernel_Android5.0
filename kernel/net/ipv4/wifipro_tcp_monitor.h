...
#define WIFIPRO_MONITOR_DELAY               (3*HZ)
#define WIFIPRO_BL_SYN_EXPIRE               (300*HZ)
#define WIFIPRO_TICK_TO_MS                  (1000/HZ)
#define WIFIPRO_MAX_BACKOFF                 6
#define WIFIPRO_RETRANS_WORK_TRIGGER        2
#define WIFIPRO_RETRANS_BACKLIST_TRIGGER    4
#define WIFIPRO_RTT_RECORD_SECONDS          3
...
extern wifipro_trigger_sock_t *wifipro_trigger_sock;
extern wifipro_rtt_second_stat_t *wifipro_rtt_second_stat_head;
extern wifipro_g_sock_bl_t *wifipro_g_sock_head;
extern wifipro_cong_sock_t *wifipro_congestion_stat;

extern bool is_wifipro_on;
extern bool is_mcc_china;

extern unsigned int wifipro_rtt_average;
extern unsigned int wifipro_rtt_calc_pkg;
extern unsigned long wifipro_when_recorded_rtt;
